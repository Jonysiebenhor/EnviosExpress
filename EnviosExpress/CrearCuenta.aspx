<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra2.Master" AutoEventWireup="true" CodeBehind="CrearCuenta.aspx.cs" Inherits="EnviosExpress.CrearCuenta" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
         ...
         <div class="container text-center" style="   width:70%;  background-image: url('Resources/.jpg');   background-color:ghostwhite;background-repeat :no-repeat;  position:page; z-index: auto;" >
           ...
           <asp:TextBox ID="txttelefono" runat="server" placeholder="Teléfono" Width="200px"></asp:TextBox>
            ...
            <asp:Button ID="Button1" runat="server" Text="&lt; Regresar" OnClick="Button1_Click" BackColor="#FF3300" ForeColor="White" />
&nbsp;
            <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="Crear Cuenta" />
            <br />
            <br /></div>
      </asp:Content>