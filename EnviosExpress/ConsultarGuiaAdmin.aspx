<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra.Master" AutoEventWireup="true" CodeBehind="ConsultarGuiaAdmin.aspx.cs" Inherits="EnviosExpress.ConsultarGuiaAdmin" %>
...
<br /><br />
 ...
 <p>
        ...
        &nbsp;<asp:DropDownList ID="DropDownList1" runat="server" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" Width="187px" Visible="False">
                   ...
                   <asp:ListItem>Hacer Cambios</asp:ListItem>
                    <asp:ListItem>Cambiar Monto</asp:ListItem>
...
&nbsp;
        ...
        <asp:Label ID="monto11" runat="server" Font-Bold="True" Font-Italic="False" Font-Overline="False" ForeColor="Black" Font-Size="Large"></asp:Label><asp:TextBox ID="txtmonto11" runat="server" Visible="False" Width="45px"></asp:TextBox>
