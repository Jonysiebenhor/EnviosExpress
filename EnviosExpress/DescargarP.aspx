<%@ Page Title="" Language="C#" MasterPageFile="~/PaginaMaestra2.Master" AutoEventWireup="true" CodeBehind="DescargarP.aspx.cs" Inherits="EnviosExpress.DescargarP" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
        ...
        <asp:Label ID="fecha22" runat="server"></asp:Label>
         ...
         <br />
        <br /></div> <br />
        <asp:Button ID="btnGenerarPDF" runat="server" Text="Descargar Guia" OnClick="btnGenerarPDF_click"/>
             &nbsp;&nbsp;
        ...
        <asp:Button ID="btnrecolectar10" runat="server" OnClick="btnrecolectar10_Click" Text="&lt;&lt; Inicio" BackColor="#FF3300" ForeColor="White" />
